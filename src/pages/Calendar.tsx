...
const Calendar: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="w-full rounded-sm border border-stroke shadow-default dark:border-strokedark dark:bg-boxdark bg-white">
                    ...
                    return (
                      <td
                        ...
                        className={`relative h-12 cursor-pointer border border-stroke p-1 text-center transition duration-500 ${
                          day ? (hasData ? 'bg-blue-500 text-white' : 'font-medium text-black dark:text-white') : 'bg-gray-100 dark:bg-gray-800'
                        } hover:bg-opacity-80 dark:border-strokedark dark:hover:bg-meta-4`}
